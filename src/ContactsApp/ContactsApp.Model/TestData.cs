namespace ContactsApp.Model
{
    ...
    public static class TestData
    {
        ...
        /// Список полных имен.
        /// </summary>
        private static List<string> _fullNameList = new List<string>() { "Ivan Ivanov", "Petr Petrovich", "Efim Efimov", "Denis Denisov" };

        /// <summary>
        /// Список Email.
        /// </summary>
        private static List<string> _emailList = new List<string>() { "IvanIvanov@mail.ru", "PetrPetrovich@mail.ru", "EfimEfimov@mail.ru", "DenisDenisov@mail.ru" };

        /// <summary>
        /// Список номера телефонов.
        /// </summary>
        private static List<string> _phoneNumberList = new List<string>() { "+79966361590", "+79966221590", "+79966361880", "+79911361590" };

        /// <summary>
        /// Список ID Вконтакте.
        /// </summary>
        private static List<string> _vkIdList = new List<string>() { "ivan2222", "billy111", "bestMan123", "krutoeID" };
